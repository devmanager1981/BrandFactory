...
3. WHEN an image is generated THEN the System SHALL calculate a **Pixel Difference Heatmap** comparing the generated product cutout to the Master product image [New].
4. WHEN the product difference exceeds a 5% threshold THEN the System SHALL flag the image for manual review [New].
